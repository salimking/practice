...
function defineSequence(imagesLoaded, Hammer) {
    ...
    var Sequence = (function(element, options) {
            ...
            function D(a, b) { for (var d in a) { var e = a[d]; if (!C(e, "-") && i[e] !== c) return b == "pfx" ? e : !0 } return !1 }
            ...
            var d = "2.8.3",
                ...
                t = [],
                u = t.slice,
                v, w = function(a, c, d, e) { var h, i, j, k, l = b.createElement("div"),
                        m = b.body,
                ...
                x = {}.hasOwnProperty,
                y;
            !B(x, "undefined") && !B(x.call, "undefined") ? y = function(a, b) { return x.call(a, b) } : y = function(a, b) { return b in a && B(a.constructor.prototype[b], "undefined") }, Function.prototype.bind || (Function.prototype.bind = function(b) { var c = this; if (typeof c != "function") throw new TypeError; var d = u.call(arguments, 1),
                    e = function() { if (this instanceof e) { var a = function() {};
                            a.prototype = c.prototype; var f = new a,
                                g = c.apply(f, d.concat(u.call(arguments))); return Object(g) === g ? g : f } return c.apply(b, d.concat(u.call(arguments))) }; return e }), q.touch = function() { var c; return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : w(["@media (", l.join("touch-enabled),("), g, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(a) { c = a.offsetTop === 9 }), c }, q.css ' %}' %
        }
        animations = function() { return F("animationName") }, q.css ' %} ' %
    }
    transforms = function() { return !!F("transform") }, q.css ' %}' %
}
transitions = function() { return F("transition") }, q.svg = function() { return !!b.createElementNS && !!b.createElementNS(p.svg, "svg").createSVGRect };
...
return e.addTest = function(a, b) {
    ...
    return e
}, z(""), h = j = null, e._version = d, e._prefixes = l, e._domPrefixes = o, e._cssomPrefixes = n, e.testProp = function(a) { return D([a]) }, e.testAllProps = F, e.testStyles = w, e.prefixed = function(a, b, c) { return b ? F(a, b, c) : F(a, "pfx") }, e
        ...
        addStyles: function() {
            ...
            if (self.options.preloader === true) {
                ...
                if (this.styleElement.styleSheet) {
                    this.styleElement.styleSheet.css ' %} ' %
                }
                Text = this.defaultStyles;
            } else {
